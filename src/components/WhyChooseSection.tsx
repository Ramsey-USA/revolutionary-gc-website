      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="text-center group">
            ...
            <p className="text-medium-gray dark:text-dark-text-secondary">Combined construction expertise across our team</p>
          </div>
          <div className="text-center group">
            ...
            <p className="text-medium-gray dark:text-dark-text-secondary">Military precision and integrity in every project</p>
          </div>
          <div className="text-center group">
            <div className="bg-charcoal dark:bg-charcoal text-white dark:text-white w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-4 transition-all duration-500 hover:scale-110 hover:-translate-y-2 shadow-lg group-hover:shadow-xl group-hover:rotate-6">
              <Bot size={40} />
            </div>
            <h3 className="text-xl font-bold text-black dark:text-dark-text mb-2 group-hover:text-charcoal dark:group-hover:text-charcoal transition-colors duration-300">Technology Leader</h3>
            <p className="text-medium-gray dark:text-dark-text-secondary">First in the Pacific Northwest with AI estimating</p>
          </div>
          <div className="text-center group">
            <div className="bg-mh-leather-tan dark:bg-mh-leather-tan text-white dark:text-white w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-4 transition-all duration-500 hover:scale-110 hover:-translate-y-2 shadow-lg group-hover:shadow-xl group-hover:rotate-6">
              <Headphones size={40} />
            ...
            <p className="text-medium-gray dark:text-dark-text-secondary">Real-time updates and transparent communication</p>
          </div>
        </div>
      </div>
    </section>
