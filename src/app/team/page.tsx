...
export default function TeamPage() {
  const leadership = [
    {
      ...
      email: "jeremy@mhconstruction.com",
    ...
    },
    {
      ...
      email: "arnold@mhconstruction.com",
  ...
  const projectManagement = [
    {
      ...
      email: "makayla@mhconstruction.com"
    },
    {
      name: "Ben Woodall",
      title: "Project Manager",
    ...
    },
    {
      ...
      email: "ronaldo@mhconstruction.com"
    }
  ]
  ...
  const fieldOperations = [
    {
      ...
      email: "steve@mhconstruction.com"
    },
    {
      name: "Reagan",
      ...
      email: "reagan@mhconstruction.com"
    },
    {
      name: "Porter Cline",
      title: "Superintendent",
      ...
      email: "porter@mhconstruction.com"
    },
    {
      name: "Jesse Pachino",
      title: "Superintendent",
      ...
      email: "jesse@mhconstruction.com"
    }
  ]
  ...
  const administration = [
    {
      ...
      email: "brooks@mhconstruction.com"
    },
    {
      name: "Brittney",
      title: "HR Manager",
      ...
      email: "brittney@mhconstruction.com"
    },
    {
      name: "Matt Ramsey",
    ...
    },
    {
      ...
      email: "jennifer@mhconstruction.com"
    }
  ]

  const TeamSection = ({ title, members, bgColor = "bg-white" }: { title: string, members: any[], bgColor?: string }) => (
              ...
              <div className="p-6">
                ...
                <div className="flex space-x-3">
                  <a
                    ...
                    className="flex items-center justify-center w-8 h-8 bg-mh-forest-green text-white rounded-full hover:bg-army-green transition-colors"
                  >
                    <Mail size={16} />
                  </a>
                  {member.linkedin && (
  ...
  return (
    <main className="min-h-screen">
      ...
      {/* Project Management */}
      <TeamSection title="Project Management & Estimating" members={projectManagement} bgColor="bg-light-gray" />

      {/* Field Operations */}
      <TeamSection title="Site & Field Operations" members={fieldOperations} />

      {/* Administration */}
      <TeamSection title="Administration & Support" members={administration} bgColor="bg-light-gray" />
