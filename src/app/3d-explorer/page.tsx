...
export default function ThreeDExplorerPage() {
  ...
  return (
    <main className="min-h-screen bg-white dark:bg-dark-surface transition-colors duration-300">
      ...
      {/* Hero Section */}
      <section className="relative pt-32 pb-20 bg-gradient-to-r from-army-gold to-yellow-500 dark:from-dark-surface-2 dark:to-dark-surface-3 text-army-black dark:text-dark-text overflow-hidden">
      ...
      <section className="py-20 bg-white dark:bg-dark-surface transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-gray-900 dark:bg-dark-surface-2 rounded-xl overflow-hidden shadow-2xl mb-16">
            ...
            <div className="relative h-96 bg-gradient-to-b from-gray-700 to-gray-900 dark:from-dark-surface-2 dark:to-dark-surface-3 flex items-center justify-center">
              <div className="text-center text-white">
                ...
                <button className="bg-army-gold dark:bg-army-gold text-army-black dark:text-army-black px-8 py-3 rounded-lg font-semibold hover:bg-yellow-500 dark:hover:bg-yellow-600 transition-colors">
                  Launch Demo Tour
                </button>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {featuredProjects.map((project, index) => (
              <div key={index} className="bg-white dark:bg-dark-surface-2 rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300 border border-gray-100 dark:border-dark-border">
                  ...
                  <div className="absolute top-4 right-4">
                    <span className={`px-3 py-1 rounded-full text-sm font-semibold ${
                      project.status === 'Available for 3D Tour' 
                        ...
                        : 'bg-yellow-500 dark:bg-yellow-600 text-army-black dark:text-army-black'
                    }`}>
                      {project.status}
                    </span>
                  </div>
                ...
                <div className="p-6">
                  <h3 className="text-xl font-bold text-army-black dark:text-army-gold mb-2">
                    {project.title}
                  </h3>
                  <p className="text-field-gray dark:text-dark-text mb-4">
                    {project.description}
                  </p>
                  
                  {project.status === 'Available for 3D Tour' ? (
                    <button className="w-full bg-army-gold dark:bg-army-gold text-army-black dark:text-army-black px-6 py-3 rounded-lg font-semibold hover:bg-yellow-500 dark:hover:bg-yellow-600 transition-colors">
                      Launch 3D Tour
                    </button>
                  ) : (
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-army-gold dark:bg-army-gold rounded-full mt-2 flex-shrink-0"></div>
                  <span className="text-field-gray dark:text-dark-text-secondary">High-resolution 360° photography with smooth transitions</span>
                </li>
                <li className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-army-gold dark:bg-army-gold rounded-full mt-2 flex-shrink-0"></div>
                  <span className="text-field-gray dark:text-dark-text-secondary">Interactive hotspots with detailed construction information</span>
                </li>
                <li className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-army-gold dark:bg-army-gold rounded-full mt-2 flex-shrink-0"></div>
                  <span className="text-field-gray dark:text-dark-text-secondary">WebGL-powered 3D rendering for smooth performance</span>
                </li>
                <li className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-army-gold dark:bg-army-gold rounded-full mt-2 flex-shrink-0"></div>
                  <span className="text-field-gray dark:text-dark-text-secondary">Mobile-optimized interface for tablets and smartphones</span>
                </li>
                <li className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-army-gold dark:bg-army-gold rounded-full mt-2 flex-shrink-0"></div>
                  <span className="text-field-gray dark:text-dark-text-secondary">VR headset compatibility for immersive experiences</span>
                </li>
              </ul>
            </div>
            
            <div className="bg-white dark:bg-dark-surface-2 p-8 rounded-xl shadow-lg border border-gray-100 dark:border-dark-border">
              <h3 className="text-xl font-bold text-army-black dark:text-army-gold mb-4">System Requirements</h3>
              <div className="space-y-3 text-field-gray dark:text-dark-text">
                <p><strong className="text-army-black dark:text-white">Browser:</strong> Chrome, Safari, Firefox, Edge (latest versions)</p>
                <p><strong className="text-army-black dark:text-white">Connection:</strong> Broadband internet recommended</p>
                <p><strong className="text-army-black dark:text-white">Hardware:</strong> Modern device with WebGL support</p>
                <p><strong className="text-army-black dark:text-white">VR:</strong> Oculus, HTC Vive, or compatible headset</p>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* CTA Section */}
      <section className="py-20 bg-gradient-to-r from-mh-forest-green to-army-green dark:from-dark-surface-2 dark:to-dark-surface-3 text-white dark:text-dark-text transition-colors duration-300">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="bg-army-gold dark:bg-army-gold text-army-black dark:text-army-black px-8 py-4 rounded-lg text-lg font-semibold hover:bg-yellow-500 dark:hover:bg-yellow-600 transition-colors transform hover:scale-105">
              Start 3D Tour
            </button>
            <a
              href="/contact"
              className="bg-transparent border-2 border-white dark:border-dark-text text-white dark:text-dark-text px-8 py-4 rounded-lg text-lg font-semibold hover:bg-white dark:hover:bg-dark-text hover:text-mh-forest-green dark:hover:text-dark-surface transition-colors transform hover:scale-105"
            >
              Schedule Demo
            </a>
          </div>
