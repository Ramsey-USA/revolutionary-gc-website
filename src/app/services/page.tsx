        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 relative">
            ...
            <div className="relative z-10 py-8">
              <h2 className="text-4xl md:text-5xl font-bold text-army-black dark:text-dark-text mb-4 relative">
                <span className="bg-gradient-to-r from-army-black dark:from-dark-text via-mh-forest-green dark:via-mh-forest-green to-army-black dark:to-dark-text bg-clip-text text-transparent">
              ...
              <p className="text-xl text-field-gray dark:text-dark-text-secondary max-w-3xl mx-auto leading-relaxed">
                ...
                <span className="font-semibold text-mh-forest-green dark:text-mh-forest-green"> military precision</span> and 
              ...
              return (
                <div key={index} className="group bg-white dark:bg-dark-surface-2 rounded-xl shadow-lg border border-gray-200 dark:border-dark-border overflow-hidden hover:shadow-2xl hover:border-army-gold dark:hover:border-army-gold transition-all duration-500 transform hover:-translate-y-2">
                  ...
                  <div className="p-6 group-hover:bg-gradient-to-br group-hover:from-gray-50 dark:group-hover:from-dark-surface-3 group-hover:to-white dark:group-hover:to-dark-surface-2 transition-all duration-300">
                    ...
                    <div className="space-y-2">
                      <h4 className="font-semibold text-army-black dark:text-dark-text mb-3 group-hover:text-mh-forest-green dark:group-hover:text-mh-forest-green transition-colors duration-300">Key Services:</h4>
                      {service.features.map((feature, featureIndex) => (
                        <div key={featureIndex} className="flex items-center space-x-2 group-hover:transform group-hover:translate-x-1 transition-transform duration-300" style={{ transitionDelay: `${featureIndex * 50}ms` }}>
                          <div className="w-2 h-2 bg-army-gold dark:bg-army-gold rounded-full group-hover:bg-mh-forest-green dark:group-hover:bg-mh-forest-green group-hover:scale-125 transition-all duration-300"></div>
          ...
          <div className="mt-20 py-16 bg-gradient-to-r from-gray-50 dark:from-dark-surface-2 to-white dark:to-dark-surface transition-colors duration-300 rounded-2xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div className="text-center group">
                <div className="relative">
                  <div className="w-16 h-16 bg-mh-forest-green dark:bg-mh-forest-green rounded-full flex items-center justify-center mx-auto mb-4 group-hover:bg-army-gold dark:group-hover:bg-army-gold group-hover:scale-110 transition-all duration-300">
                  ...
                  {/* Connector Line */}
                  <div className="hidden lg:block absolute top-8 left-full w-full h-0.5 bg-gradient-to-r from-mh-forest-green to-gray-300 dark:from-mh-forest-green dark:to-dark-border"></div>
                </div>
                <h4 className="text-xl font-bold text-army-black dark:text-dark-text mb-2 group-hover:text-mh-forest-green transition-colors duration-300">Consultation</h4>
              ...
              <div className="text-center group">
                ...
                <h4 className="text-xl font-bold text-army-black dark:text-dark-text mb-2 group-hover:text-mh-forest-green transition-colors duration-300">Planning & Design</h4>
              ...
              <div className="text-center group">
                ...
                <h4 className="text-xl font-bold text-army-black dark:text-dark-text mb-2 group-hover:text-mh-forest-green transition-colors duration-300">Construction</h4>
              ...
              <div className="text-center group">
                ...
                <h4 className="text-xl font-bold text-army-black dark:text-dark-text mb-2 group-hover:text-mh-forest-green transition-colors duration-300">Delivery</h4>
            ...
            <div className="text-center mt-12">
              ...
              <a
                href="/estimate"
                className="inline-block bg-mh-forest-green dark:bg-mh-forest-green text-white dark:text-white px-8 py-3 rounded-lg font-semibold hover:bg-army-green dark:hover:bg-army-green transition-colors duration-300 transform hover:scale-105"
              >
          ...
          <div className="text-center mt-16">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a
                href="/contact"
                className="bg-mh-forest-green dark:bg-mh-forest-green text-white dark:text-white px-8 py-4 rounded-lg text-lg font-semibold hover:bg-army-green dark:hover:bg-army-green transition-colors transform hover:scale-105"
              >
                Contact Us
              </a>
            </div>
