...
export default function WoundedWarriorPage() {
  return (
    <div className="min-h-screen bg-white dark:bg-dark-surface pt-20 transition-colors duration-300">
      ...
      {/* Hero Section */}
      <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-army-black via-mh-forest-green to-army-green dark:from-dark-surface dark:via-dark-surface-2 dark:to-dark-surface-3 overflow-hidden pt-24">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="mb-8">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-16">
              <button className="bg-army-gold dark:bg-army-gold text-army-black dark:text-army-black px-10 py-4 rounded-lg text-lg font-bold hover:bg-yellow-500 dark:hover:bg-yellow-500 transition-all duration-300 transform hover:scale-105 hover:-translate-y-1 shadow-lg">
                Get Involved Today
              </button>
            ...
            {/* Mission Badge */}
            <div className="inline-flex items-center bg-mh-forest-green/80 dark:bg-mh-forest-green/80 backdrop-blur-sm px-6 py-3 rounded-full">
              <div className="w-8 h-8 bg-army-gold dark:bg-army-gold rounded-full flex items-center justify-center mr-3">
      ...
      {/* Mission Statement */}
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white dark:bg-dark-surface transition-colors duration-300">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl md:text-5xl font-bold text-army-black dark:text-dark-text mb-8">Our Mission</h2>
          <div className="text-lg text-field-gray dark:text-dark-text-secondary space-y-6 leading-relaxed">
            <p>
      ...
      {/* Impact Stats */}
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-mh-warm-tan/10 dark:bg-dark-surface-2 transition-colors duration-300">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center bg-white dark:bg-dark-surface-2 p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow border border-transparent dark:border-dark-border">
              <div className="text-5xl md:text-6xl font-bold text-army-gold dark:text-army-gold mb-4">3</div>
            ...
            <div className="text-center bg-white dark:bg-dark-surface-2 p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow border border-gray-100 dark:border-dark-border">
              <div className="text-5xl md:text-6xl font-bold text-mh-forest-green dark:text-army-gold mb-4">2</div>
            ...
            <div className="text-center bg-white dark:bg-dark-surface-2 p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow border border-gray-100 dark:border-dark-border">
              <div className="text-5xl md:text-6xl font-bold text-army-green dark:text-army-gold mb-4">50+</div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Volunteer Card */}
            <div className="border-2 border-army-gold/30 dark:border-army-gold/50 rounded-xl p-8 text-center hover:border-army-gold transition-all duration-300 bg-white dark:bg-dark-surface-2 shadow-lg hover:shadow-xl transform hover:-translate-y-2">
              <div className="w-16 h-16 bg-army-gold/10 dark:bg-army-gold/20 rounded-full flex items-center justify-center mx-auto mb-6">
            ...
            {/* Donate Card */}
            <div className="border-2 border-mh-forest-green/30 dark:border-mh-forest-green/50 rounded-xl p-8 text-center hover:border-mh-forest-green transition-all duration-300 bg-white dark:bg-dark-surface-2 shadow-lg hover:shadow-xl transform hover:-translate-y-2">
              <div className="w-16 h-16 bg-mh-forest-green/10 dark:bg-mh-forest-green/20 rounded-full flex items-center justify-center mx-auto mb-6">
              ...
              <button className="bg-mh-forest-green text-white px-8 py-3 rounded-lg font-bold hover:bg-green-700 transition-all duration-300 w-full transform hover:scale-105">
                Make a Donation
              </button>
            </div>

            {/* Partner Card */}
            <div className="border-2 border-army-green/30 dark:border-army-green/50 rounded-xl p-8 text-center hover:border-army-green transition-all duration-300 bg-white dark:bg-dark-surface-2 shadow-lg hover:shadow-xl transform hover:-translate-y-2">
              <div className="w-16 h-16 bg-army-green/10 dark:bg-army-green/20 rounded-full flex items-center justify-center mx-auto mb-6">
          ...
          <div className="bg-white dark:bg-dark-surface-2 rounded-xl shadow-xl overflow-hidden border border-gray-100 dark:border-dark-border">
            <div className="md:flex">
              <div className="md:w-1/2">
                <div className="aspect-video bg-gradient-to-r from-army-black to-mh-forest-green flex items-center justify-center">
              ...
              <div className="md:w-1/2 p-8">
                ...
                <div className="space-y-4 mb-8">
                  ...
                  <div>
                    ...
                    <div className="w-full bg-gray-200 dark:bg-dark-surface-3 rounded-full h-3">
                      <div className="bg-mh-forest-green h-3 rounded-full transition-all duration-500" style={{width: '84%'}}></div>
                    </div>
                  </div>
                </div>
