    ...
    <div className="min-h-screen bg-white dark:bg-dark-surface pt-20 transition-colors duration-300">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="mb-8">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-16">
              <button className="bg-mh-leather-tan dark:bg-mh-leather-tan text-white dark:text-white px-10 py-4 rounded-lg text-lg font-bold hover:bg-mh-hunter-green dark:hover:bg-mh-hunter-green transition-all duration-300 transform hover:scale-105 hover:-translate-y-2 shadow-lg hover:shadow-xl">
                Get Involved Today
              </button>
              <button className="border-2 border-mh-leather-tan dark:border-mh-leather-tan text-mh-leather-tan dark:text-mh-leather-tan px-10 py-4 rounded-lg text-lg font-bold hover:bg-mh-leather-tan dark:hover:bg-mh-leather-tan hover:text-white dark:hover:text-white transition-all duration-300 transform hover:scale-105 hover:-translate-y-2 shadow-lg">
                Learn More
              </button>
            </div>
      ...
      <section className="py-20 bg-gray-50 dark:bg-gray-900 border-l-8 border-mh-hunter-green dark:border-mh-hunter-green">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <h2 className="text-4xl lg:text-5xl font-bold mb-8 text-black dark:text-dark-text leading-tight">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-mh-leather-tan/10 dark:bg-dark-surface-2 transition-colors duration-300">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl md:text-5xl font-bold text-center text-black dark:text-dark-text mb-16">Making a Difference</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center bg-white dark:bg-dark-surface-2 p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-500 border border-transparent dark:border-dark-border transform hover:scale-105 hover:-translate-y-2 group">
              <div className="text-5xl md:text-6xl font-bold text-mh-leather-tan dark:text-mh-leather-tan mb-4 transition-all duration-300 group-hover:scale-110">3</div>
              <div className="text-xl font-bold text-black dark:text-dark-text mb-2">Homes Built</div>
              <div className="text-medium-gray dark:text-dark-text-secondary">Adaptive homes completed for wounded veterans</div>
            </div>
            <div className="text-center bg-white dark:bg-dark-surface-2 p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-500 border border-gray-100 dark:border-dark-border transform hover:scale-105 hover:-translate-y-2 group">
              <div className="text-5xl md:text-6xl font-bold text-mh-hunter-green dark:text-mh-leather-tan mb-4 transition-all duration-300 group-hover:scale-110">2</div>
              <div className="text-xl font-bold text-black dark:text-mh-leather-tan mb-2">In Progress</div>
              <div className="text-medium-gray dark:text-dark-text-secondary">Homes currently under construction</div>
            </div>
            <div className="text-center bg-white dark:bg-dark-surface-2 p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-500 border border-gray-100 dark:border-dark-border transform hover:scale-105 hover:-translate-y-2 group">
              <div className="text-5xl md:text-6xl font-bold text-mh-hunter-green dark:text-mh-leather-tan mb-4 transition-all duration-300 group-hover:scale-110">50+</div>
              <div className="text-xl font-bold text-black dark:text-mh-leather-tan mb-2">Volunteers</div>
              <div className="text-medium-gray dark:text-dark-text-secondary">Community members helping build</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl md:text-5xl font-bold text-center text-black mb-16">How You Can Help</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Volunteer Card */}
            <div className="border-2 border-mh-leather-tan/30 dark:border-mh-leather-tan/50 rounded-xl p-8 text-center hover:border-mh-leather-tan transition-all duration-500 bg-white dark:bg-dark-surface-2 shadow-lg hover:shadow-xl transform hover:-translate-y-2 group">
              <div className="w-16 h-16 bg-mh-leather-tan/10 dark:bg-mh-leather-tan/20 rounded-full flex items-center justify-center mx-auto mb-6 transition-transform duration-300 group-hover:rotate-12 group-hover:scale-110">
              ...
              <p className="text-medium-gray dark:text-dark-text mb-6 leading-relaxed">Join our construction crews, help with logistics, or provide specialized skills</p>
              <button className="bg-mh-leather-tan text-white px-8 py-3 rounded-lg font-bold hover:bg-mh-hunter-green transition-all duration-300 w-full transform hover:scale-105">
            ...
            <div className="border-2 border-mh-hunter-green/30 dark:border-mh-hunter-green/50 rounded-xl p-8 text-center hover:border-mh-hunter-green transition-all duration-500 bg-white dark:bg-dark-surface-2 shadow-lg hover:shadow-xl transform hover:-translate-y-2 group">
              ...
              <p className="text-medium-gray dark:text-dark-text mb-6 leading-relaxed">Help fund materials, adaptive equipment, and specialized construction needs</p>
              <button className="bg-mh-hunter-green text-white px-8 py-3 rounded-lg font-bold hover:bg-mh-leather-tan transition-all duration-300 w-full transform hover:scale-105">
                Make a Donation
              </button>
            </div>
            ...
            <div className="border-2 border-mh-hunter-green/30 dark:border-mh-hunter-green/50 rounded-xl p-8 text-center hover:border-mh-hunter-green transition-all duration-500 bg-white dark:bg-dark-surface-2 shadow-lg hover:shadow-xl transform hover:-translate-y-2 group">
              ...
              <p className="text-medium-gray dark:text-dark-text mb-6 leading-relaxed">Partner with us through materials donation, services, or corporate sponsorship</p>
              <button className="bg-mh-hunter-green text-white px-8 py-3 rounded-lg font-bold hover:bg-mh-leather-tan transition-all duration-300 w-full transform hover:scale-105">
                Become a Partner
              </button>
            </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-50 dark:bg-dark-surface transition-colors duration-300">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl md:text-5xl font-bold text-center text-black dark:text-mh-leather-tan mb-16">Current Project</h2>
          <div className="bg-white dark:bg-dark-surface-2 rounded-xl shadow-xl overflow-hidden border border-gray-100 dark:border-dark-border">
            <div className="md:flex">
              <div className="md:w-1/2">
                <div className="aspect-video bg-gradient-to-r from-black to-mh-hunter-green flex items-center justify-center transition-all duration-500 hover:from-mh-hunter-green hover:to-black">
              ...
              <div className="md:w-1/2 p-8">
                <h3 className="text-3xl font-bold text-black dark:text-mh-leather-tan mb-4">Home for Sergeant Martinez</h3>
                <p className="text-medium-gray dark:text-dark-text mb-6 leading-relaxed">
                ...
                <div className="space-y-4 mb-8">
                  <div>
                    ...
                    <div className="w-full bg-gray-200 dark:bg-dark-surface-3 rounded-full h-3">
                      <div className="bg-mh-leather-tan h-3 rounded-full transition-all duration-500" style={{width: '75%'}}></div>
                    </div>
                  </div>
                  <div>
                    <div className="flex justify-between text-sm font-bold text-black dark:text-mh-leather-tan mb-2">
                ...
                <p className="text-sm text-medium-gray dark:text-dark-text-secondary mb-6 font-semibold">Estimated completion: March 2024</p>
                <button className="bg-mh-leather-tan text-white px-8 py-4 rounded-lg font-bold hover:bg-mh-hunter-green transition-all duration-300 transform hover:scale-105">
